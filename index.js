...
client.once("ready", async () => {
  ...
  const musicSlash = [
    ...
    new SlashCommandBuilder().setName("nowplaying").setDescription("Show the currently playing track with controls"),
    ...
    new SlashCommandBuilder().setName("spotify").setDescription("See what someone is listening to on Spotify").addUserOption(o=>o.setName("user").setDescription("User to check").setRequired(false)),
